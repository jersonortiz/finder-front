...
function eliminar(value) {
    let loadurl = url + 'habilidad/eliminar';
    ...
    if (confirm("eliminar habilidad?") == true) {
        fetch(loadurl, init)
                .then((resp) => resp.json())
                .then(function (data) {
...
function loadstart() {
    ...
    let loadurl = url + 'habilidad/listuser?' + idurl;
    let init = makeinitnodat();


    $('#habilidadtabla').empty();
            ...
            .then(function (data) {
                ...
                $.each(data, function (i, item) {
                    fill += '<tr>' +
                            '<td>' + item.nombre + '</td>' +
                            '<td>' +
                            '<button type="button" class="btn btn-info" value="' + item.certificado + '" onclick="descarga(this.value)" title="descargar">' +
