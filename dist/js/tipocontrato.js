...
function editar(value) {
    location.href = "./editartipocontrato.html?id=" + value;
}

function eliminar(value) {
    let loadurl = url + 'tipocontrato/eliminar';
    ...
    if (confirm("eliminar tipo de contrato?") == true) {
        fetch(loadurl, init)
                .then((resp) => resp.json())
                .then(function (data) {
...
function loadstart() {
    ...
    let loadurl = url + 'tipocontrato/list?' + idurl;
