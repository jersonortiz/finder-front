...
function editar(value) {
    location.href = "./editarsector.html?id=" + value;
}

function eliminar(value) {
    let loadurl = url + 'sector/eliminar';
    ...
    if (confirm("eliminar sector , todas las profesiones asignadas al sector seran eliminadas?") == true) {
        fetch(loadurl, init)
                .then((resp) => resp.json())
                .then(function (data) {
