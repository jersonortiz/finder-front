...
function editar(value) {
    location.href = "./editarcompetencia.html?id=" + value;
}

function eliminar(value) {
    let loadurl = url + 'competencia/eliminar';
    ...
    if (confirm("eliminar competencia?") == true) {
        fetch(loadurl, init)
                .then((resp) => resp.json())
                .then(function (data) {
...
function loadstart() {
    ...
    let loadurl = url + 'competencia/listuser?' + idurl;
    let init = makeinitnodat();


    $('#competenciatabla').empty();
